...
//initialize libphonenumber
	require_once "app/ld_billing/resources/libphonenumber/vendor/autoload.php";
	$locale = 'CA';
	$phoneUtil = \libphonenumber\PhoneNumberUtil::getInstance();

//get http post variables and set them to php variables
	if (is_array($_POST)) {
		$message_from_raw = $phoneUtil->parse($_POST["message_from"], $locale);
		$message_to_raw = $phoneUtil->parse($_POST["message_to"], $locale);
		
		$message_from = $phoneUtil->format($message_from_raw, \libphonenumber\PhoneNumberFormat::E164);
		$message_to = $phoneUtil->format($message_to_raw, \libphonenumber\PhoneNumberFormat::E164);
...
// Code generated by postman
	...
	curl_setopt_array($curl, array(
	  CURLOPT_URL => "https://messaging.bandwidth.com/api/v2/users/5005150/messages",
	  ...
	  CURLOPT_POSTFIELDS =>"{\n  \"from\": \"$message_from\",\n  \"to\": \"$message_to\",\n  \"text\": \"$message_text\",\n  \"applicationId\": \"28376af2-c766-443f-b90c-21c57dc520f0\"\n}",
	  CURLOPT_HTTPHEADER => array(
		"Content-Type: application/json",
		"Authorization: Basic Yjc3ZjQ1MGE1ZWQxMTFhNzYwM2E4OTMwOWVkMThiNjU4MTMxNzdmNTdhODQzY2FlOmI1Mjk2YjAxNmNmNWE3YTE4NjljNjA3NGM3N2Y2ZDkwNDVhZTc4OGQ3NGUyZGMwMw=="
	  ),
	));
